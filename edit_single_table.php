...
/*
 * How to manage foreign keys 
 * it can be multiple field key, can not be avoided
 * It can be avoided if there are only single column primary keys and single column unique keys
 * multiple column primary key can be converted to single column (with description including all columns)
 * if a FK refer to PK,
 * ********/
